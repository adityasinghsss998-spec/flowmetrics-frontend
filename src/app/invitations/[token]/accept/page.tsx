...
import { CheckCircle2, AlertCircle, Loader2, ArrowRight, Building2, LogIn } from 'lucide-react'
  ...
  useEffect(() => {
    const handleAccept = async () => {
      ...
      if (!storedToken && !isAuthenticated) {
        // Redirect to login preserving this target
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center text-center space-y-4 py-4">
            ...
            <div className="pt-4 w-full flex flex-col gap-2">
              <Link
                href={`/login?redirect=/invitations/${token}/accept`}
